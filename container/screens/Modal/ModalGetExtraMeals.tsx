...
export default class ModalGetExtraMeals extends Component<Props, State> {
  state: State = {
    value: 1,
  };
  render() {
    ...
    const state = this.props.checkModalGetExtraMeals;
      ...
      <Modal animationType="slide" transparent={true} visible={state.check}>
        <View style={styles.centeredView}>
          ...
          <View style={styles.modalView}>
            <Text style={styles.modalTextTitle}>Chọn số suất ăn nhận thêm</Text>
